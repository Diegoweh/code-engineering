  ...
  return (
    <main className="min-h-screen">
      ...
      <header className="relative w-full h-screen overflow-hidden">
        ...
        >
          <source src="/video/fade-two/fade-two-compressed.mp4" type="video/mp4" />
          <track kind="captions" />
      ...
      <ImageTextSection
        ...
        title="Adicionando DOT ONE a esta herramienta, el sistema de activación por presión absoluta pasa a ser una sistema secundario e independiente de activación,"
        description="por lo que pasa a tener sistemas redundantes que permiten la activación tanto por presión diferencial (Tubería-Reservorio) como presión absoluta contra la cámara atmosférica, esto garantiza la infalibilidad de la herramienta. Si las operaciones de terminación previas, tales como asentamiento de empacador o prueba de tubería están programadas con presiones muy altas, FADE TWO.1, puede ser adicionada con “PLUS+” aditamento que le otorga protección contra activación hasta tanto la presión de la tubería un valor programado menor que la presión de reservorio."
        imagePosition="right"
      ...
      <ImageTextSection
        ...
        imageAlt="Nuestra empresa"
        title="Todas las herramientas FADE incluyendo esta, siempre ofrecen una opción de respaldo con el uso de “TORPEDO” el cual puede ser usado para accionar de manera remota la herramienta."
        description=""
        imagePosition="left"
        backgroundColor="bg-transparent"
        titleColor="text-white"
      ...
      <ImageTextSection
        ...
        imageAlt="Nuestra empresa"
        title={`FFADE TWO: Activada por presión absoluta.

                FADE TWO.1: Activada por presión Diferencial Tubería-Yacimiento.

                FADE TWO.1+: Activada por presión Diferencial Tubería-Yacimiento. Con mecanismo de protección contra activación previa.`}
        description=""
        imagePosition="right"
        backgroundColor="bg-transparent"
        titleColor="text-white"
